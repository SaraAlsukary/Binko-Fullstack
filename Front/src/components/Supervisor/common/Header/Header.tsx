    ...
    return (
        <header className="headerSuper">
            <Container className='content'>
                <div className='logo'><NavLink to='/Binko/supervisor'>{language === 'English' ? 'Supervisor Dashboard' : 'لوحة تحكم المشرف'}</NavLink></div>
                <ul className='list'>
                    ...
                    <li onClick={() => setShow(!show)} className='pro'><div className={theme === 'Dark' ? `prof dark` : `prof`}>{userData?.user?.name} {show ? <i className='pi pi-angle-up'></i> : <i className='pi pi-angle-down'></i>}</div></li>
